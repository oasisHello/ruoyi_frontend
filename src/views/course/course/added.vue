    ...
    <el-row :gutter="15">
      <el-form ref="formRef" :model="formData" :rules="rules" size="default" label-width="100px">
        <el-col :span="24">
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="课程编号" prop="subjectcode">
                <el-input v-model="formData.subjectcode" type="text" placeholder="请输入课程编号" clearable
                  :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="学科" prop="subject_name">
                <el-select v-model="formData.subject_name" placeholder="请选择学科" clearable
                  :style="{width: '100%'}">
                  <el-option v-for="(item, index) in subject_nameOptions" :key="index" :label="item.label"
          ...
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="课程名称" prop="class_name">
                <el-input v-model="formData.class_name" type="text" placeholder="课程名称" clearable
                  :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
          ...
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="下拉选择" prop="field108">
                <el-select v-model="formData.field108" placeholder="请选择下拉选择" clearable
                  :style="{width: '100%'}">
        ...
        <el-col :span="23">
          <el-row gutter="15">
            <el-col :span="10">
              <el-form-item label="课程封面" prop="field113" required>
        ...
        <el-col :span="24">
          <el-row gutter="15">
            <el-col :span="24">
              <el-form-item label="多行文本" prop="field117">
                <el-input v-model="formData.field117" type="textarea" placeholder="请输入多行文本"
